	...
	return (
		<section className="relative min-h-screen flex flex-col p-4 sm:p-6 lg:p-8">
			...
			<div className="relative flex-1 rounded-2xl sm:rounded-3xl overflow-hidden">
				...
				{/* Content */}
				<div className="relative z-10 flex-1 flex items-end px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto min-h-[calc(100vh-2rem)] sm:min-h-[calc(100vh-3rem)] lg:min-h-[calc(100vh-4rem)] pb-16">
